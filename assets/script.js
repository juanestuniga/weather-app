$(document).ready(function () {
 ...
 //global variables
  let city;
  let cities;
  let apiKey = "204e43a642757a7f284598294a41c6fe";

 //Load most recetnt search
...
//recently searched cities from local storage
  ...
  function search() {
    ...
    //Function to get 5-day forecast and UV index 
    function getUV(lat, lon) {
     
        
      $.ajax({
        url: "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&exclude=minutely,hourly" + "&units=imperial&appid=204e43a642757a7f284598294a41c6fe",
        method: "GET",
      }).then(function (response) {
...
//load recently searched cities to page
  function listCities() {
    $("#cityList").text("");
    cities.forEach((city) => {
